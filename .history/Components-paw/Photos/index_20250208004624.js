    ...
    return (
        <div>
            ...
            <div className={styles.container}>
                <img className={styles.img2} src="/site-photos-paw/Paw-paw-uniform.png" alt="paw-by-paw-snacks" />
            ...
            <img className={styles.img1} src="/site-photos-paw/Paw-paw-uniform.png" alt="paw-uniform" />
        </div>
    );
};
