...
const Photos = () => {
    return (
        <div>
            <img className={styles.img1} src="/site-photos-paw/Poster.jpg" alt="Paw By Paw Branding" />
            ...
            <div className={styles.container}>
                ...
                <img className={styles.img1} src="/site-photos-paw/dog-training.jpg" alt="Paw By Paw Branding" />
            </div>
        </div>
    );
};
