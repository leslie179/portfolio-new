...
const Logo = () => {
  ...
  const items = [
    { src: "/site-photos-paw/griddy-doogo.png", alt: "Description of Image 1", text: "This brand is founded on the belief that there are no inherently bad dogs, only those that lack proper training.  dogs are happier and better behaved, as they understand what is expected of them. Our logo features a Akita, a breed known for its stubbornness—showing that even the most willful dogs can achieve a state of peace and contentment with the right training approach. " },
