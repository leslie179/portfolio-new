...
import styles from './LayoutComponent.module.css'; // Adjust the path as necessary

const LayoutComponent = () => {
  // Array of images and their descriptions for demonstration
  const items = [
    { src: "path-to-your-image1.jpg", alt: "Description of Image 1", text: "Lorem ipsum dolor sit amet..." },
