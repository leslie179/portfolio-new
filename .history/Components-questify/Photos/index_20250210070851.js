...
const Photos = () => {
    return (
        ...
        <h1 className={styles.h1}>Low-fi wireframes</h1>
            ...
            <img className={styles.img3} src="/site-photos-questify/Final.png" alt="wellness-post" loading="lazy" />
            <h1 className={styles.h1}>Hi-fi wireframes</h1>
            <img className={styles.img3} src="/site-photos-questify/HighFid.png" alt="wellness-post" loading="lazy" />
        </div>
    );
};
