    ...
    return (
        <div className={styles.headerContainer}>
            ...
            <div className={`${styles.annotationContainer1} ${styles.annotation2}`}>
                ...
                <div className={`${styles.whiteBox} ${styles.whiteBox1}`}>
                    <p>The logo uses a lot of round edges curves and flows, resembling the natural ingridients used in the candle from the sea. Also allowing the brand to come</p>
                </div>
            </div>
