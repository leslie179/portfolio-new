        ...
        <div className={styles.headerContainer}>
            ...
            <div className={`${styles.annotationContainer1} ${styles.annotation1}`}>
                ...
                <div className={`${styles.whiteBox} ${styles.whiteBox1}`}>
                    <p>A customized flame is carved in the middle of the d to represent the fire/ canle aspect of the brand. It also resembles the company moto of lighting up the flame of each customer's heart keeping them </p>
                </div>
            </div>
