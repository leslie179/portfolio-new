    ...
    return (
        <div className={styles.headerContainer}>
            ...
            <div className={styles.rightColumn}>
                ...
                Wellness journey is a company that provides alternative health solutions for families. They aim for naturopath options to help heal bodies from the core. Client also want sophisticated grounding feel for their brand. A brand that representants the resilience and the growing of the human body.
                </p>
