        ...
        <div className={styles.bigContainer}>
            ...
            <div className={styles.bottom}>
                ...
                <div className={styles.wrapper}>
                    ...
                    <div className={styles.rightSection}>
                    <p className={styles.p}>
    Keywords are identified based on the survey conducted with the client. Research is then carried out using these keywords, along with a competitive analysis of what competitors are doing. Keeping these keywords in mind, relevant icons or images are selected as inspiration for the logo concepts. <br />
