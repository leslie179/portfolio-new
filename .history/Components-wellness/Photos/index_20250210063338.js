        ...
        <div className={styles.bigContainer}>
            ...
            <div className={styles.bottom}>
                ...
                <div className={styles.wrapper}>
                    ...
                    <div className={styles.rightSection}>
                        <p className={styles.p}>
                          After 3 revisions, client decided to purchase more reivisons, and 3 more revisions are done and the client finally recieved the perfect branding. Final proposal is created, as well as a instruction pdf as well as 
                        </p>
                    </div>
                </div>
            </div>
