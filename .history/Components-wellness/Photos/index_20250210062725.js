        ...
        <div className={styles.bigContainer}>
            ...
            <div className={styles.bottom}>
                ...
                <div className={styles.wrapper}>
                    ...
                    <div className={styles.rightSection}>
                        <p className={styles.p}>
                           During the process of the developmentof the logo, client struggle to stick to a specific style of illustrations for her logo. Due to excess information online, this is why often times when a client is onboarding, client is not suggested to constantly search for inspiration due to this. So through revisions client suggested different types of illustrations and typography as per the inspirations she provides.
                        </p>
                    </div>
                </div>
            </div>
