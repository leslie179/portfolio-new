...
const Photos = () => {
    return (
        <div className={styles.bigContainer}>
            ...
            <div className={styles.container}>
                <img className={styles.img5} src="/site-photos-wellness/stic.jpg" alt="wellness-post" loading="lazy" />
            </div>
            <div className={styles.bottom}>
                ...
                <div className={styles.sideBySide}>
                    ...
                    <div className={styles.item}>
                        ...
                        <img className={styles.img4} src="/site-photos-wellness/moodboard.png" alt="moodboard" loading="lazy" />
                    </div>
                </div>
            </div>
