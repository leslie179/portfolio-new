                ...
                <div className={styles.wrapper}>
                    ...
                    <div className={styles.rightSection}>
                        <p className={styles.p}>
                           After recieving a branding survey from the agency, a brand proposal is created temporarily according to the likes and dislikes of the client and the businesses necessities, a detailed proposal is created in order to 
                        showcase and confirm the direction of the brand will be going, confirming with clients whether the direction we are taking is what they envisioned.
                        </p>
                    </div>
                </div>
                <div className={styles.wrapper}>
