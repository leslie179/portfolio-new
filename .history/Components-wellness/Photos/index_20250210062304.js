        ...
        <div className={styles.bigContainer}>
            ...
            <div className={styles.bottom}>
                ...
                <div className={styles.wrapper}>
                            ...
                            <div className={styles.rightSection}>
                                <p className={styles.p}>
                                    After creating and trying out different combos of logo layout and typhogarphy, the best logo will be chosen and perfected. The logo will also be put into different prototypes and another proposal will be created with the logo, moodboard, color palette, different 
                                </p>
                            </div>
                        </div>
            </div>
