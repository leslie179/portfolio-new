    ...
    <div className={styles.wrapper}>
        ...
        <div className={styles.rightSection}>
            <p className={styles.p}>
                After signing contract with the agency, a survey was completed by the client and information about the desired brand is gathered. Client wants "The idea is to incorporate the concept of renewal (possibly sun inspo or liner lines to show a path) and/or life (possibly thumbprint inspo) into a logo. This is to show a patient walking their unique path to wellness." After 
            </p>
        </div>
    </div>
</div>
