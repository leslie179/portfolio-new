            ...
            <div className={styles.bottom}>
                ...
                <div className={styles.sideBySide}>
                    <div className={styles.item}>
                        ...
                        <img className={styles.img6} src="/site-photos-wellness/drafts.jpg" alt="drafts" />
                    </div>
                    <div className={styles.item}>
                        <h1 className={styles.h1}>Moodboard</h1>
                        <img className={styles.img4} src="/site-photos-wellness/moodboard.png" alt="moodboard" />
                    </div>
                </div>
            </div>
