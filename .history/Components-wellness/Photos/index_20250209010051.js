    ...
    return (
        <div>
            ...
            <div className={styles.container}>
                ...
                <div className={styles.container}>
                <img className={styles.img2} src="/site-photos-wellness/brand-photo.jpg1" alt="mug" />
                <img className={styles.img5} src="/site-photos-wellness/wellness-post-1.png" alt="wellness-post" />                
            </div>
