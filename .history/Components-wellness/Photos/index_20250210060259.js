...
const Photos = () => {
    ...
    <div className={styles.wrapper}>
        ...
        <div className={styles.leftSection}>
            <h2 className={styles.heading}>Step 2 - Proposal</h2>
            <img
                className={styles.logoImage}
                src="/site-photos-wellness/drafts.jpg"
                alt="Rejected Logos"
        ...
        <div className={styles.rightSection}>
            <p className={styles.p}>
           A proposal of the direction of the brand is created in order to ensure and confirm with client that the direction of the brand is correct. Assets such as moodboards, colors are temporaily selected to give a brief version for the brand. THrough out the development the moodboard, 
            </p>
        </div>
    </div>
</div>
