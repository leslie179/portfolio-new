                ...
                <div className={styles.wrapper}>
                    ...
                    <div className={styles.rightSection}>
                        <p className={styles.p}>
                           After recieving a branding survey from the agency, a brand proposal is created temporarily according to the likes and dislikes of the client and the businesses
                        </p>
                    </div>
                </div>
                <div className={styles.wrapper}>
