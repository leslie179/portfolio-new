    ...
    return (
        <div className={styles.container}>
            ...
            <div className={styles.contain}>
                <div className={styles.leftColumn}>
                    <h2 className={styles.title200}>2. User Research</h2>
                    <p className={styles.paragraph}>
            ...
            <div className={styles.contentContainer}>
                <div className={styles.column}>
                    ...
                    <div className={styles.section}>
                        <h2 className={styles.title600}>Constant anxiety</h2>
                        <p className={styles.p5}>
                    ...
                    <div className={styles.section}>
                        <h2 className={styles.title600}>Vague menus</h2>
                        <p className={styles.p5}>
            ...
            <div className={styles.contain}>
                <div className={styles.leftColumn}>
                    <h2 className={styles.title2}>3. Competitive Analysis</h2>
                    <p className={styles.paragraph}>
            ...
            <div className={styles.contain}>
                <div className={styles.leftColumn}>
                    <h2 className={styles.title2}>4. Personas</h2>
                    <p className={styles.paragraph}>
            ...
            <div className={styles.contain}>
                <div className={styles.leftColumn}>
                    <h2 className={styles.title2}>5. Branding</h2>
                    <p className={styles.paragraph}>
            ...
            <div className={styles.contain}>
                <div className={styles.leftColumn}>
                    <h2 className={styles.title2}>6. User Journey</h2>
                    <p className={styles.paragraph}>
            ...
            <div className={styles.contain}>
                <div className={styles.leftColumn}>
                    <h2 className={styles.title2}>7. Wire Frames</h2>
                    <p className={styles.paragraph}>
            ...
            <h2 className={styles.h100}>Concerns presented by usability testing</h2>
            ...
            <div className={styles.contain10}>
                <div className={styles.leftColumn10}>
                    <h2 className={styles.title12}>8. Promotional Assets</h2>
            ...
            <div className={styles.contain}>
                <div className={styles.leftColumn}>
                    <h2 className={styles.title12}>9. Promotional video</h2>                       
                </div>
            </div>
            ...
            <div className={styles.figmaEmbedContainer}>
                <iframe
                    className={styles.figmaIframe}
                    src="https://www.figma.com/embed?embed_host=share&url=https://www.figma.com/proto/QQNbhVtuF8ATLTZjSzYgQw/Screens?node-id=2601-16334&p=f&scaling=scale-down&content-scaling=fixed&page-id=2601%3A10685&starting-point-node-id=2601%3A16239&hide-ui=1"
                    frameBorder="0"
                    allowFullScreen
            ...
            <div className={styles.contentContainer}>
                <div className={styles.leftColumn1}>
                    <h2 className={styles.title2000}>11. Potential business ventures</h2>
                    <img className={styles.img10} src="site-photos-goldibite/group-photo.png" />
                </div>

                <div className={styles.rightColumn1}>
