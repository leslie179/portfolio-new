        ...
        <div className={styles.container}>
            ...
            <div className={styles.contain10}>
                <div className={styles.leftColumn10}>
                    <h2 className={styles.title2}>8. Promotional Assets</h2>
            ...
            <div className={styles.contain}>
                <div className={styles.leftColumn}>
                    <h2 className={styles.title2}>9. Promotional video</h2>
                ...
                <div className={styles.leftColumn}>
                    ...
                    <div className={styles.figmaContainer}>
                        <iframe
                            ...
                            src="<iframe style="border: 1px solid rgba(0, 0, 0, 0.1);" width="800" height="450" src="https://embed.figma.com/proto/QQNbhVtuF8ATLTZjSzYgQw/Screens?node-id=2601-16334&p=f&scaling=min-zoom&content-scaling=fixed&page-id=2601%3A10685&starting-point-node-id=2601%3A16239&show-proto-sidebar=1&embed-host=share" ></iframe>"
                            allowFullScreen
                        ></iframe>
                    </div>
                </div>
