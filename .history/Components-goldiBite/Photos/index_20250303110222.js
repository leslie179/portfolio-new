...
<div className={styles.contentContainer}>
    ...
    <div className={styles.column}>
        ...
        <div className={styles.section1}>
            ...
            <div className={styles.contain}>
                <div className={styles.leftColumn}>
                    <h2 className={styles.h2}>9. Promotional Assets</h2>
                    <div className={styles.videoResponsive}>
                        <iframe
                            width="853"
                            height="480"
        ...
        <div className={styles.contentContainer}>
                ...
                <div className={styles.rightColumn}>
                    <div className={styles.statsContainer}>
                        <div className={styles.stat}>
                            <h3 className={styles.statNumber}>Restaurant partnership</h3>
                            <p className={styles.statDescription}>
                               ...
                               the application, allowing them to position themselves as a allergy
                            </p>
                        </div>
                        <div className={styles.stat1}>
                            <h3 className={styles.statNumber1}>7.4 million +</h3>
