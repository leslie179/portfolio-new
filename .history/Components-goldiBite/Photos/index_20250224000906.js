...
const Photos = () => {
    return (
        <div className={styles.container}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 p-8 font-sans">
      <div className="space-y-8">
        <div>
          <h2 className="text-2xl font-extrabold">Tideous process of locating safe restaurants</h2>
        ...
        <div>
          <h2 className="text-2xl font-extrabold">Constant anxiety</h2>
          <p className="text-base">
        ...
        <div>
          <h2 className="text-2xl font-extrabold">Vague menus</h2>
          <p className="text-base">
        ...
        <div>
          <h2 className="text-2xl font-extrabold">Recipe planner</h2>
          <p className="text-base">
      ...
      <div className="space-y-8">
        <div>
          <h2 className="text-2xl font-extrabold">Limited allergy/intolerance support for non-english speakers</h2>
          <p className="text-base">
        ...
        <div>
          <h2 className="text-2xl font-extrabold">Restaurants not being trained to cater to food allergy/intolerance</h2>
          <p className="text-base">
