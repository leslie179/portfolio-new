...
const Photos = () => {
    return (
      ...
      <div className={styles.column}>
        ...
        <div className={styles.section}>
          <h2 className={styles.title}>Vague menus</h2>
          <p>
        ...
        <div className={styles.section}>
          <h2 className={styles.title}>Recipe planner</h2>
          <p>
      ...
      <div className={styles.column}>
        <div className={styles.section}>
          <h2 className={styles.title}>Limited allergy/intolerance support for non-english speakers</h2>
          <p>
        ...
        <div className={styles.section}>
          <h2 className={styles.title}>Restaurants not being trained to cater to food allergy/intolerance</h2>
          <p>
