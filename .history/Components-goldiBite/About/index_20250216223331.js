    ...
    return (
        <div className={styles.headerContainer}>
            ...
            <div className={styles.rightColumn}>
                ...
                Goldi Bites is a travel-friendly app for tourists with dietary restrictions, ensuring safe dining and shopping. It features a barcode and menu scanner that translates ingredients and allergens into the user’s language. The app also provides localized emergency resources, including hotlines and allergy protocols. With a focus on safety and accessibility, Goldi Bites helps travelers make informed food choices anywhere.
