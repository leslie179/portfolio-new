    ...
    return (
        <div className={styles.headerContainer}>
            ...
            <div className={styles.rightColumn}>
                ...
                GoldiBite is a travel-friendly app for tourists with dietary restrictions, ensuring safe dining and shopping. It features a barcode and menu scanner that translates ingredients and allergens into the user’s language. <br /> <br />The app also provides localized emergency resources, including hotlines and allergy protocols. With a focus on safety and accessibility, GoldiBite helps travelers make informed food choices anywhere.</p>
