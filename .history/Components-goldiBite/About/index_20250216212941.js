    ...
    return (
        <div className={styles.headerContainer}>
            ...
            <div className={styles.rightColumn}>
                ...
                <br></br>Beyond food safety, Goldi Bites provides localized emergency resources, including hotlines and allergy protocols, so travelers know what to do in case of a reaction. With a focus on accessibility and convenience, the app empowers users to make informed dining decisions while exploring new places.
                </p>
