...
const Banner = () => {
    ...
    const backgrounds = [
        { '/site-photos/Candl-Branding.png', type: 'left' },
        { '/site-photos/Paw-By-Paw-Branding.jpg', type: 'right' },
        { '/site-photos/four-golf-flag.png', type: 'full' },
        { '/site-photos/Candl.png', type: 'left' },
        { '/site-photos/amma-tote-bag.png', type: 'right' },
        { '/site-photos/Candl.png', type: 'left' },
        { '/site-photos/amma-tote-bag.png', type: 'right' },
        { '/site-photos/paw-by-paw-branding.jpg', type: 'full' }
    ];
