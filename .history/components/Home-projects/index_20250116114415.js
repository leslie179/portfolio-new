    ...
    return (
        <div className={styles.HomeProjects}>
            ...
            <div className={styles.container}>
                <div className={styles.parallaxBlock} style={{ transform: `translateY(${offsetY * 0.2}px)` }}>
                ...
                <div className={styles.parallaxBlock} style={{ transform: `translateY(${offsetY * 0.1}px)` }}>
                ...
                <div className={styles.parallaxBlock} style={{ transform: `translateY(${offsetY * 0.05}px)` }}>
