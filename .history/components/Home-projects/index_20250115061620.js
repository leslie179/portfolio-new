    ...
    return (
        <div className={styles.HomeProjects}>
            ...
            <div className={styles.container}>
                <img src="/site-photos/candl-branding.png" alt="Candl Branding" className={styles.firstImage} />
                <img src="/site-photos/paw-by-paw-branding.jpg" alt="Paw By Paw Branding" className={styles.secondImage} />
