...
const Video = () => {
    return (
        <div className={styles.container}>
            ...
            <div className={`${css-spinner-demo}`}>
            <span className={`${styles.spinnerConfetti} ${styles.cssOk}`}>👌</span>
                    <span className={`${styles.spinnerConfettiConfetti} ${styles.cssTree}`}>🎍</span>
                    <span className={`${styles.spinnerConfettiConimatfetti} ${styles.cssAnimationConfetti}`}>😍</span>
            </div>
