...
const Video = () => {
    return (
        <div className={styles.container}>
            ...
            <div className={waap1-spinner-demo}>
            <span className="spinner-confetti wappi-spinner-confetti Ok">👌</span>
                    <span className="spinner-confetti wappi-spinner-confetti Tree">🎍</span>
                    <span className=className="spinner-confetti wappi-spinner-confetti Ok">😍</span>
            </div>
