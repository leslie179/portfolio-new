    ...
    if (swimmingPoolRef.current) {
      ...
      interval = setInterval(() => {
        ...
        if (swimmingGirlRef.current) {
          ...
          swimmingGirlRef.current.style.transform = `rotate(${Math.atan2(
            follow.y,
            follow.x
          ) * (180 / Math.PI)}deg)`;
        }
