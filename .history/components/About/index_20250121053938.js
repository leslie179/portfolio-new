    ...
    return (
        <div className={styles.gridContainer}>
            <div className={styles.imageColumn}>
                <img src="/site-photos/leslie-photo.png" alt="Leslie with a drink" className={styles.image1} />
                <img src="/site-photos/leslie-and-hermie.png" alt="Leslie with her dog" className={styles.image2} />
            </div>
