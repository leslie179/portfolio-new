    ...
    return (
        <div className={styles.gridContainer}>
            ...
            <div className={styles.textContent}>
                ...
                <p className={styles.h2}>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur gravida eros nec dui scelerisque, sit amet viverra nulla venenatis. Aliquam erat volutpat.</p>
