...
const BlockThree = () => {
    ...
    <div className={styles.photoGrid}>
        <img src="/site-photos/leslie-photo1.png" alt="Leslie in the living room" />
        <img src="/site-photos/leslie-photo2.png" alt="Leslie with her dog" />
    </div>
    <div className={styles.column}>
        <h1 className={styles.column}>Hi, I'm Leslie!</h1>
