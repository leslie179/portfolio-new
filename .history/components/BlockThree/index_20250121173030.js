            ...
            <div className={styles.stickyBlock}>
                ...
                <div className={styles.gridContainer}>
                    <div className={styles.imageColumn}>
                        ...
                        <img src="/site-photos/leslie-and-hermie1.png" alt="Leslie with her dog" style={{ width: '50%', position: 'relative', top: '35%', left: '30%', zIndex: 2, transform: 'rotate(-5deg)', animation: ' animation: wiggleAnimation 1s ease-in-out infinite' }} />

                    </div>
                    <div className={styles.textContent}>
                        <h2 className={styles.title}>Hi, I'm Leslie!</h2>
